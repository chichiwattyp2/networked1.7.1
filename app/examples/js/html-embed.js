!(function(e) {
  ...
  function(e, t, s) {
    ...
    AFRAME.registerComponent("htmlembed", {
      schema: { ppu: { type: "number", default: 256 } },
      init: function() {
        var e = new i(
          this.el,
          () => {
        ...
        const s = new THREE.MeshBasicMaterial({ map: t, transparent: !0 });
        ...
        this.el.setObject3D("screen", n),
          ...
          this.el.addEventListener("raycaster-intersected-cleared", e => {
            this.htmlcanvas.clearHover(), (this.raycaster = null);
          }),
        ...
        if ((this.resize(), this.raycaster)) {
          ...
          if (e) {
            ...
            var s = this.width / 2,
              i = this.height / 2,
              a = Math.round(
                ((t.x + s) / this.width) * this.htmlcanvas.canvas.width
              ),
              n = Math.round(
                (1 - (t.y + i) / this.height) * this.htmlcanvas.canvas.height
              );
            (this.lastX == a && this.lastY == n) ||
              this.htmlcanvas.mousemove(a, n),
              (this.lastX = a),
              (this.lastY = n);
          }
        }
  ...
  function(e, t) {
    ...
    e.exports = class {
      constructor(e, t, s) {
        if (!e) throw "Container Element is Required";
        var i;
            ...
            for (var s = 0; s < e.length; s++)
              if (e[s].target != this.html || "attributes" != e[s].type) {
                if (!e[s].target.styleRef || "class" == e[s].attributeName) {
                  ...
                  if (e[s].target.styleRef == a) continue;
        ...
        a.observe(this.html, { attributes: !0, childList: !0, subtree: !0 }),
          (this.observer = a),
          (this.cssgenerated = []),
          (this.cssembed = []),
      ...
      hashChanged() {
        if (window.clearedHash != window.location.hash) {
          ...
          if ((e && e.classList.remove("targethack"), window.location.hash)) {
            var t = document.querySelector(window.location.hash);
            t && t.classList.add("targethack");
          }
        }
        (window.clearedHash = window.location.hash), this.svgToImg();
      }
      cleanUp() {
        ...
        for (var e = document.styleSheets, t = 0; t < e.length; t++)
          try {
            for (var s = e[t].cssRules, i = [], a = 0; a < s.length; a++) {
              s[a].cssText.indexOf(":hover") > -1 &&
                i.push(
                  s[a].cssText.replace(new RegExp(":hover", "g"), ".hoverhack")
                ),
                s[a].cssText.indexOf(":active") > -1 &&
                  i.push(
                    s[a].cssText.replace(
                      new RegExp(":active", "g"),
                      ".activehack"
            ...
            for (a = 0; a < i.length; a++) e[t].insertRule(i[a]);
          } catch (e) {}
      }
      dbj2(e) {
      ...
      csssig(e) {
        if ((e.classCache || (e.classCache = {}), !e.classCache[e.className])) {
      ...
      embedCss(e, t) {
        return new Promise(s => {
          ...
          t = (t = (t = (t = t.replace(
            new RegExp(":hover", "g"),
            ".hoverhack"
          )).replace(new RegExp(":active", "g"), ".activehack")).replace(
            new RegExp(":focus", "g"),
            ".focushack"
          )).replace(new RegExp(":target", "g"), ".targethack");
          const n = RegExp(/url\((?!['"]?(?:data):)['"]?([^'"\)]*)['"]?\)/gi);
          for (; (i = n.exec(t)); )
            a.push(
              this.getDataURL(new URL(i[1], e)).then(
                (e => s => {
                  t = t.replace(e[1], s);
                })(i)
              )
      ...
      getURL(e) {
        return (
          (e = new URL(e, window.location).href),
          new Promise(t => {
        ...
        for (
          ...
          if (-1 == this.cssgenerated.indexOf(i)) {
            ...
            this.cssgenerated.push(i),
              "STYLE" == i.tagName
                ? t.push(
                    this.embedCss(window.location, i.innerHTML).then(
                      ((e, t) => e => {
                        this.cssembed[t] = e;
                      })(0, a)
                    )
                ...
                : t.push(
                    this.getURL(i.getAttribute("href")).then(
                      (e => t => {
                        var s = new TextDecoder("utf-8").decode(t.response);
                        return this.embedCss(window.location, s).then(
                          ((e, t) => e => {
                            this.cssembed[t] = e;
                          })(0, e)
                        );
      ...
      embededSVG() {
        for (
          var e = [], t = this.html.querySelectorAll("*"), s = 0;
          s < t.length;
          s++
        ) {
          ...
          if (
            ...
            "IMG" == t[s].tagName &&
              "data" != t[s].src.substr(0, 4) &&
              e.push(
                this.getDataURL(t[s].src).then(
                  (e => t => {
                    e.setAttribute("src", t);
                  })(t[s])
                )
              ),
            "http://www.w3.org/1999/xhtml" == t[s].namespaceURI &&
              t[s].hasAttribute("style"))
          ) {
            var a = t[s].getAttribute("style");
            e.push(
              this.embedCss(window.location, a).then(
                ((e, t) => s => {
        ...
        for (s = 0; s < n.length; s++)
          e.push(
            this.embedCss(window.location, n[s].innerHTML).then(
              (e => t => {
      ...
      updateFocusBlur() {
        for (
          var e = this.html.querySelectorAll("*"), t = 0;
          t < e.length;
          t++
        ) {
          var s = e[t];
          s.tabIndex > -1
            ? (s.hasOwnProperty("focus") ||
                (s.focus = (e => () => this.setFocus(e))(s)),
              s.hasOwnProperty("blur") ||
                (s.blur = (e => () => this.focusElement == e && this.setBlur())(
                  s
                )))
            : (delete s.focus, delete s.blur);
        }
      }
      getParents() {
        var e = [],
        ...
        do {
          ...
          var a =
            "<" +
            ("body" == i ? 'body xmlns="http://www.w3.org/1999/xhtml"' : i) +
          ...
          e.unshift(a);
          var n = "</" + i + ">";
          if ((t.push(n), "body" == i)) break;
        } while ((s = s.parentNode));
        return [e.join(""), t.join("")];
      }
      updateCheckedAttributes() {
        for (
          var e = this.html.getElementsByTagName("input"), t = 0;
          t < e.length;
          t++
        ) {
          var s = e[t];
          s.hasAttribute("checked")
            ? s.checked || s.removeAttribute("checked")
            : s.checked && s.setAttribute("checked", "");
        }
      }
      svgToImg() {
        this.updateFocusBlur(),
          Promise.all([this.embededSVG(), this.generatePageCSS()]).then(() => {
            ...
            (e =
              ...
              "</foreignObject></svg>"),
              (this.img.src =
                "data:image/svg+xml;utf8," + encodeURIComponent(e)),
              (this.html.style.display = "none");
          });
      }
      render() {
      ...
      transformPoint(e, t, s, i, a) {
        ...
        if (0 == n.indexOf("matrix(")) {
          ...
          if (0 != n.indexOf("matrix3d(")) return [t, s, z];
          (r = new THREE.Matrix4()),
            (h = n
              .substring(9, n.length - 1)
              .split(", ")
              .map(parseFloat)),
            (r.elements = h);
        }
      ...
      getBorderRadii(e, t) {
        for (
          ...
          for (
            var r = t[i[n]], h = /(\d*)([a-z%]{1,3})/gi, l = [];
            (s = h.exec(r));

          )
            l.push({ value: s[1], unit: s[2] });
          1 == l.length && l.push(l[0]), a.push(l);
        }
        const o = { px: 1, "%": e.offsetWidth / 100 };
        var c = [];
        for (n = 0; n < a.length; n++) {
          for (var u = a[n], d = ((l = []), 0); d < u.length; d++)
      ...
      checkInBorder(e, t, s, i, a, n) {
        if ("0px" == t["border-radius"]) return !0;
        var r,
          h,
          l = e.offsetWidth,
          o = e.offsetHeight,
          c = this.getBorderRadii(e, t);
        return (
          !(
            s < c[0][0] + a &&
            i < c[0][1] + n &&
          ...
          (!(
            ...
            (!(
              s > a + l - c[2][0] &&
              i > n + o - c[2][1] &&
              (r = (s - (a + l - c[2][0])) / c[2][0]) * r +
                (h = (i - (n + o - c[2][1])) / c[2][1]) * h >
                1
            ) &&
              !(
                s < c[3][0] + a &&
      ...
      checkElement(e, t, s, i, a, n, r, h) {
        if (r.offsetParent) {
          var l = window.getComputedStyle(r),
            ...
            m = l["z-index"];
          if (
            ("auto" != m && ((a = 0), (n = parseInt(m))),
            "static" != l.position && r != this.html && "auto" == m && (a += 1),
            ("block" == l.display || "inline-block" == l.display) &&
              "none" != l.transform)
          ) {
            var v = this.transformPoint(l, e, t, o, c);
            if (!v) return;
            (e = v[0]), (t = v[1]), "auto" == m && (a += 1);
          }
          if (e > o && e < o + u && t > c && t < c + d)
            this.checkInBorder(r, l, e, t, o, c) &&
              (a >= h.zIndex || n > h.level) &&
              n >= h.level &&
              "none" != l["pointer-events"] &&
              ((h.zIndex = a), (h.ele = r), (h.level = n));
          else if ("visible" != l.overflow) return;
          var f = r.firstChild;
          if (f)
            do {
              1 == f.nodeType &&
                (f.offsetParent == r
                  ? this.checkElement(e, t, s + o, i + c, a, n, f, h)
                  : this.checkElement(e, t, s, i, a, n, f, h));
            } while ((f = f.nextSibling));
        }
      }
      elementAt(e, t) {
        this.html.style.display = "block";
        var s = { zIndex: 0, ele: null, level: 0 };
        return (
          this.checkElement(e, t, 0, 0, 0, 0, this.html, s),
          (this.html.style.display = "none"),
          s.ele
        );
      }
      moveMouse() {
        var e = this.moveX,
          ...
          a = { clientX: e, clientY: t, button: s || 0, bubbles: !1 },
          n = this.elementAt(e, t);
        if (n != this.lastEle)
          if (n) {
            n.tabIndex > -1 &&
              this.eventCallback &&
              this.eventCallback("focusableenter", { target: n }),
              this.lastEle &&
                this.lastEle.tabIndex > -1 &&
                this.eventCallback &&
                this.eventCallback("focusableleave", { target: this.lastEle });
            var r = [],
              h = n;
            this.lastEle &&
              this.lastEle.dispatchEvent(new MouseEvent("mouseout", i)),
              n.dispatchEvent(new MouseEvent("mouseover", i));
            do {
              if (h == this.html) break;
              -1 == this.overElements.indexOf(h) &&
                (h.classList && h.classList.add("hoverhack"),
      ...
      setFocus(e) {
        e.dispatchEvent(new FocusEvent("focus")),
          e.dispatchEvent(
            new CustomEvent("focusin", { bubbles: !0, cancelable: !1 })
          ),
      ...
      setBlur() {
        this.focusElement &&
          ...
          this.focusElement.dispatchEvent(
            new CustomEvent("focusout", { bubbles: !0, cancelable: !1 })
          ));
      }
      clearHover() {
        var e;
        for (
          this.moveTimer &&
          (clearTimeout(this.moveTimer), (this.moveTimer = !1));
          (e = this.overElements.pop());
        ...
        this.lastEle &&
          this.lastEle.dispatchEvent(
            new MouseEvent("mouseleave", { bubbles: !0, cancelable: !0 })
          ),
          (this.lastEle = null);
        var t = document.querySelector(".activeElement");
        t && (t.classList.remove("activehack"), (this.activeElement = null));
      }
      mouseup(e, t, s) {
        var i = {
            screenX: e,
        ...
        this.activeElement &&
          ...
          a &&
            (a.classList.add("hoverhack"),
            -1 == this.overElements.indexOf(a) && this.overElements.push(a)),
          (this.activeElement = null)),
          a
            ? (a.dispatchEvent(new MouseEvent("mouseup", i)),
              a != this.focusElement &&
                (this.setBlur(),
                a.tabIndex > -1
                  ? this.setFocus(a)
                  : (this.focusElement = null)),
              a == this.mousedownElement &&
                (a.dispatchEvent(new MouseEvent("click", i)),
                "INPUT" == a.tagName && this.updateCheckedAttributes(),
                ("INPUT" != a.tagName &&
                  "TEXTAREA" != a.tagName &&
                  "SELECT" != a.tagName) ||
                  (this.eventCallback &&
                    this.eventCallback("inputrequired", { target: a }))))
            : (this.focusElement &&
                this.focusElement.dispatchEvent(new FocusEvent("blur")),
              (this.focusElement = null));
      }
